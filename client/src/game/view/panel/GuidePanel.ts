 ...
 */
class GuidePanel extends BasePanel
{
    private imgRect0:eui.Image;
    private imgRect1:eui.Image;
    private imgRect2:eui.Image;
    private imgRect3:eui.Image;
    private imgDialog:eui.Image;
    private lblGuide1:eui.Label;
    private lblGuide2:eui.Label;
    private imgMask:eui.Image;
    private imgGirl:eui.Image;
    ...
    public _descIndex: number = 0;
    public _descFinish: boolean = false;
    public _isShow: boolean = false;

    public _callback: Function;
    public _thisObj: Object;
    public _lblShow:number ;
    ...
    public initData():void
    {
        ...
        var excX:number = Global.getStageHeight() / 800;
        var excY:number = Global.getStageWidth() / 480;
    ...
    private showHand(headPosX:number,handPosY:number):void
    {
        var excX:number = Global.getStageHeight() / 800;
        var excY:number = Global.getStageWidth() / 480;
    ...
    {
        this._descIndex++;
        var length1:number = this._dialog1.length;
        var length2:number = this._dialog2.length;
        var totalLength:number = length1 + length2;
