...
class NetEnterCmd extends BaseCmd
{
    ...
    public init():void
    {
        ...
        let level = UserProxy.inst.curArea;
        let heroArr = [].concat(UserProxy.inst.fightData.getPVEBattleHero(), UserProxy.inst.fightData.getMonster(level, true));
        let resArr = fight.getRolePathArr(heroArr);
