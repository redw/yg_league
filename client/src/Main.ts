...
class Main extends eui.UILayer
{
    ...
    protected createChildren():void
    {
        ...
        //初始化Resource资源加载库
        var resURL:string = "resource/default.res.json?v=" + ExternalUtil.inst.getVersion();
    ...
    private onResComplete(event:RES.ResourceEvent):void
    {
        ...
        //
        var themeURL:string = "resource/default.thm.json?v=" + ExternalUtil.inst.getVersion();
    ...
    {
        var platform:string = ExternalUtil.inst.getPlatform() ;
        var configName:string = "config_" + platform ;
        RES.getResByUrl(Global.getResURL(configName + ".json?v=" + ExternalUtil.inst.getVersion()), function (data:any):void
        {
